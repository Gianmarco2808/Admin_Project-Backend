...
export class AuthController {
     ...
     static login = async (req: Request, res: Response) => {
          try {
               ...
               if (!user.confirmed) {
                    ...
                    const error = new Error('La cuenta no ha sido confirmada, hemos enviado un nuevo token de confirmacion')
     ...
     static uptadeProfile = async (req: Request, res: Response) => {
     ...
     static uptadeCurrentUserPassword = async (req: Request, res: Response) => {
